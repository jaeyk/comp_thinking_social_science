...
This course will provide graduate students the technical skills necessary to conduct research in computational social science. This course will help students to develop proficiency with computational tools and techniques. Mastering these tools and techniques not only enables students to collect, wrangle, analyze, and interpret data easier and faster, but it also let students to work on research projects that would previously seem impossibly complex. 
