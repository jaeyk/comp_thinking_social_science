...
- And how to reduce dimensions of such text data by 
    ...
    - 3) [normalizing](https://en.wikipedia.org/wiki/Text_normalization) (e.g., stop words)
    - 4) [stemming or lemmatization](https://nlp.stanford.edu/IR-book/html/htmledition/stemming-and-lemmatization-1.html)) to reduce morphological variation
    Stemming: reduce word forms to stems car, cars, car's, cars' -> car
    Lemmatization: reduces inflectional variance (e.g., prefix, suffix); good is the lemma of better 
- In this unit, we focus on 1) and 3). For advanced noise removing, you might need to learn how to do string manipulations by using [regular expressions](https://www.regular-expressions.info/) in R.
