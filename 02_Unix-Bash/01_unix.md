...
* Jae: full disclousre. I am an avid Linux user (using the above mentioned Ubuntu). Linux has many flaws but more charms. The most attractive feature of Ubuntu is its transparency and openness. As you gain more experience with Linux, you begin to understand more about how a computer actually workd. 
