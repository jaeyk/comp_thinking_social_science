...
* I adapted the following content from Wickham's R data science book (2017) chapter: https://r4ds.had.co.nz/tidy-data.html and his earlier paper (2014) published in Journal of Statistical Software: http://www.jstatsoft.org/v59/i10/paper.

* Wickham created so many essential packages used in R for data science. For more information, please see the following website: http://hadley.nz/

# 1. What's tidy principles 
...
Computationally, this approach is good for vectorized programming because "different variables from the same observation are always paired".

## 3. Messay datasets 

### 3.1. Signs of messay datasets 
...
#### 4.1.4. Unite (multiple coulmns into one column)
