...
- But computational tools and techniques are much broader and fundamental to how we work:
...
- For things you've done, computational tools and techniques can help you do these tasks better with much less time and efforts. For a researcher, learning computational methods is equivalent to eating more nutritious foods or doing regular workouts. 
- For things you've never done, computational tools and techniques can open a new window of opportunities. For example, think about web scraping, or machine learning.
...
- Programming is similar to **cooking**.
    ...
    - But there are fundamentals. 
        ...
        - Techniques (logic)
        - Recipes (workflow)
    - Though programming is different from cooking, because it requires much more precision.
    - Basically, you learn how to talk to a computer and make the computer do what you want.
