...
-   Let's think about the following two cases (these examples come from [the column](https://dlab.berkeley.edu/blog/why-teaching-social-scientists-how-code-professional-important) I contributed to the D-Lab website) and related to the civic data science project I've been involved in for the past few years (for more information on this project, see [Mapping the Modern Agora](https://snfagora.jhu.edu/project/mapping-the-modern-agora/)). 
...
I also applied these pedagogical principles when writing this book.
