...
- If you're into writing pacakges, then read Wickham's book on [R packges](http://r-pkgs.had.co.nz/) and spend some time wiht [Writing R Extensions](https://cran.r-project.org/doc/manuals/r-release/R-exts.html) the R package development bible.